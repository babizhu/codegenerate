 ...
 * 生成action目录的js代码
 */
class GenActionCode extends GenBaseWebCode{


    private static final String TEMPLET_PATH = "resource/template/action/action.template";

    public GenActionCode( String className ){
        super( className );
